Lockdown::System.configure do
  ...
  set_permission(:browse).
    with_controller(:home).
    only_methods(:index, :main)
  ...
  set_permission(:manage_orders).
    with_controller(:orders).
  ...
  set_user_group(:csr, :manage_clients, :manage_orders)
  
  set_user_group(:estimators, :manage_clients, :manage_orders)
end 
